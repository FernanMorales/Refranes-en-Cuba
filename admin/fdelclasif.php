    ...
    <td><div id="main">
	 <div id="contenido">
	  <?php include('menu.php') ?>
	   <div id="titulo">Eliminar clasificación 
	     <div id="logout"><a href="logout.php" class="elemento logout">Salir</a></div></div>
	   <div id="cajaizq">
		 <form action="delclasif.php" method="post" name="form1" id="form1">
		 <div class="titulo">Clasificación</div>
         <?php
$cadref = "SELECT * FROM clasif WHERE id NOT IN (SELECT idclasif FROM refranclasif) ORDER BY des ASC";
...
echo '<div id="refran1" >No existen clasificadores registrados.</div>';
}
?>

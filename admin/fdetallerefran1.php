...
<?php
$i = 0;
$localtemp = $locacionesvar->item($varactual);
ksort($localtemp);
reset($localtemp);
...
<?php
echo '<div id="refran1"><br /><br /><a href="faddrefran.php" class="elemento">Adicionar refr&aacute;n</a><br /><br /></div>';
}else{
	echo '<br />Ocurrio un problema en la adición de este refran. Intentelo nuevamente.';
	echo '<div id="refran1" style="height:500px"><a href="faddrefran.php" class="elemento">Adicionar refr&aacute;n</a></div>';
}

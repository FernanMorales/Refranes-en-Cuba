    ...
    <td><div id="main">
	 <div id="contenido">
	  <?php include('menu.php') ?>
	   <div id="titulo">Modificar refr&aacute;n <div id="logout"><a href="logout.php" class="elemento logout">Salir</a></div></div>
	   <div id="cajaizq">
		 <div class="titulo">Refr&aacute;n modelo o tipo</div>
<?php
$cadref = "SELECT * FROM refranes ORDER BY des ASC";
...
$i = 0;
	...
	echo '<div id="barragris"><a href="fmodrefran.php?ref='.$id.'" class="lista">'.$des.'</a></div>';
	$i++;
	}
}else{

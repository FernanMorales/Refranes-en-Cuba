...
<table width="849" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<div id="cajabusca"><form id="form2" name="form2" method="post" action="buscador/balfa.php">
...
echo '<div id="contenido" >El sistema buscó los refranes que comienzan con la letra '.$marc.' que fueron recogidos mayor cantidad de veces</div>';	
else		  
echo '<div id="contenido" >El sistema buscó los refranes que comienzan con la letra '.$marc.'</div>';
			  if (isset($_GET['res'])){
			  ?>
			  <div id="contenido">No existen refranes que comiencen con esta letra.</div>
			  <?php
			  }else

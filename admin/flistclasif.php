...
$i = 0;
	...
	echo '<div id="barragris"><a href="fmodclasif.php?ref='.$id.'" class="lista">'.$des.'</a></div>';
	$i++;
	}
}else{
echo 'No existen clasificadores registrados.';
}
?>

...
if (isset($_POST['letra'])){
	...
	//$contorigen = 1;
	$pregunta = $letra;
	$cadreforigen = "SELECT * FROM refranes WHERE LEFT(des, 1) = '".$letra."' ORDER BY des ASC";
...
$forden = $_POST['forden'];
if ($nohay)
header("Location: ../fbalfa.php?res=1&q=".$pregunta);
else
header("Location: ../fbalfa.php?q=".$pregunta."&ford=".$forden);
?>
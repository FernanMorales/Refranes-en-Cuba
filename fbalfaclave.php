...
echo '<div id="contenido" >El sistema buscó los refranes cuya palabra clave comienza con la letra '.$marc.' que fueron recogidos mayor cantidad de veces</div>';	
else		  
echo '<div id="contenido" >El sistema buscó los refranes cuya palabra clave comienza con la letra '.$marc.'</div>';
			  if (isset($_GET['res'])){
			  ?>

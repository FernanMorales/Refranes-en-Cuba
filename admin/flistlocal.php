    ...
    <td><div id="main">
	 <div id="contenido">
	  <?php include('menu.php') ?>
	   <div id="titulo">Modificar código geográfico 
	     <div id="logout"><a href="logout.php" class="elemento logout">Salir</a></div></div>
	   <div id="cajaizq">
		 <div class="titulo">Códigos geográficos</div>
         <?php
$cadref = "SELECT * FROM localizacion ORDER BY codigo ASC";
...
$des = $codigo.'-'.$des;	
	echo '<div id="barragris"><a href="fmodlocal.php?ref='.$id.'" class="lista">'.$des.'</a></div>';
	$i++;
	}
}else{
echo 'No existen códigos geográficos registrados.';
}
?>		  
	   </div>
	 </div>

    ...
    <td><div id="main">
	 <div id="contenido">
	  <?php include('menu.php') ?>
	   <div id="titulo">Eliminar origen 
	     <div id="logout"><a href="logout.php" class="elemento logout">Salir</a></div></div>
	   <div id="cajaizq">
		 <form action="delorigen.php" method="post" name="form1" id="form1">
		 <div class="titulo">Origen</div>
         <?php
$cadref = "SELECT * FROM origen WHERE id NOT IN (SELECT idorigen FROM refranes) ORDER BY des ASC";
...
echo '<div id="refran1" >No existen origenes registrados.</div>';
}
?>
